<template>
  <div class="container mx-auto flex flex-col items-center bg-gray-100 p-4">
    ...
    <div class="container">
        ...
        <div class="flex">
          <div class="max-w-xs">
            <label for="wallet" class="block text-sm font-medium text-gray-700"
              >Тикер</label
            >
            <div class="mt-1 relative rounded-md shadow-md flex">
              <input
                type="text"
                name="wallet"
                id="wallet"
            ...
            <br />
            <div class="text-sm text-red-600" v-if="check">
      ...
      <section class="relative" v-if="selectedTicker !== null">
...
export default {
  ...
  methods: {
    subscribeToUpdate(tickerName) {
      setInterval(async () => {
        const f = await fetch(
          `https://min-api.cryptocompare.com/data/price?fsym=${tickerName}&tsyms=USD&api_key=a463ab41a67cc3e4994226fbf4c63f575f33268387dea9cc92a528380d96e738`
        );
